...
RUN pip install -U git+https://github.com/ryanlovett/jupyter-server-proxy@6c3cc8d

RUN pip install -U git+https://github.com/ryanlovett/jupyter-rsession-proxy@7fe6251
